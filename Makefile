...
DEPS = hyprland waybar gnome-terminal fuzzel mako:mako-notifier grim slurp wf-recorder wl-copy:wl-clipboard wtype wofi wob thunar brightnessctl playerctl blueman-applet:blueman gvim:vim-gtk3 ncal sox curl jq hyprpaper
