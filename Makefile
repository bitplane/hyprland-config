...
DEPS = hyprland waybar gnome-terminal fuzzel mako:mako-notifier grim slurp wf-recorder wl-copy:wl-clipboard wtype wofi thunar brightnessctl playerctl blueman-applet:blueman ncal sox curl jq hyprpaper
